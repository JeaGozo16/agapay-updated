...
const BiologicalHazard=({ navigation, route }) => {
    ...
    <ScrollView contentContainerStyle={styles.scrollViewContainer}>
      <View style={styles.container}>
        <View style={styles.header}>
          <Image source={require('../assets/maroonbiological.png')} style={styles.image} />
          <Text style={styles.text}>BIOLOGICAL HAZARD</Text>
        </View>

        <View style={styles.firstaid}>
          <Text style={styles.firstaidText}>Safety Measures</Text>
          <Text style={styles.firstaidPro}>1. Stay Calm</Text>
          <Text style={styles.firstaidPro}>2. Keep Your Distance</Text>
          <Text style={styles.firstaidPro}>3. Check the sorroundings and avoid the possible hazards</Text>
