...
const MedicalAssistance = ({ navigation, route }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollViewContainer}>
      <View style={styles.container}>
        ...
        <Text style={styles.firstaidPro}>1. Perform right first aid to MINIMAL damage</Text>
        <Text style={styles.firstaidPro}>2. Call for help and check responsive</Text>
        <Text style={styles.firstaidPro}>3. Maintain an open airway</Text>
