...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, Alert, TextInput, Modal, Dimensions, SafeAreaView } from 'react-native';
            ...
            <Modal visible={menuVisible} transparent animationType="">
                <View style={styles.modalContainerBottom}>
                    <View style={styles.modalContentBottom}>
                        <TouchableOpacity onPress={handleDelete} style={styles.modalButtonBottom}>
                            <Text style={styles.modalButtonTextBottom}>Delete</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={handlePin} style={styles.modalButtonBottom}>
                            <Text style={styles.modalButtonTextBottom}>
                                {selectedAnnouncement?.pinned ? 'Unpin' : 'Pin'}
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => setMenuVisible(false)} style={styles.modalButtonBottom}>
