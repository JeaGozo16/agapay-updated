...
const CrimeandViolence = ({ navigation, route }) => {
    ...
    <ScrollView contentContainerStyle={styles.scrollViewContainer}>
      <View style={styles.container}>
        <View style={styles.header}>
          <Image source={require('../assets/marooncrime.png')} style={styles.image} />
          <Text style={styles.text}>CRIME AND VIOLENCE</Text>
        </View>
...
export default CrimeandViolence;